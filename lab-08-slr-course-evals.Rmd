...
***The distribution is skewed, since there are not very many professors with low scores and most of them have higher scores, in between 4 and 5.  This tells me that most students rate their courses relatively high.  I expected to see more low or middling scores because students often have mixed views of professors.***
...
***There appears to be a slight increase, or positive relationship, in professors ratings based on their beauty.***
...
***Jitter means that the points are separated out a bit so that one can see overlapped values.  The initial scatterplot could be misleading because there are many values on one line, but they are not seen as easily because they are not separated out.***
...
***For an average beauty rating of 0 the average evaluation rating is 3.88.  This does not make sense in the data as there are not beauty ratings that are 0.***
...
$$\widehat{score}_i = 4.28 - 0.12\times TenureTrack_i - 0.14\times _Tenured_i$$
